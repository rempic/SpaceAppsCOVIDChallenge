 ...
 void setup(){
   ...
   madu = minim.loadFile("/Users/rempicon/Google_Drive/MYCODE/PRJ/GIT/SpaceAppsCOVIDChallenge/resources/sounds/madunina.mp3");
   madu.loop();
...
long xx = 0;
 ...
 void draw(){
   ...
   */
   ...
   String date = String.format("%s%s", mm, dd);
   message m = new message(date, 50, 318, 250);
   m.show();
   }
   
   
   //saveFrame("/Users/rempicon/Google_Drive/MYCODE/PRJ/GIT/SpaceAppsCOVIDChallenge/resources/submission/video_frames_v2/dt_####.pgm");
   count++;
